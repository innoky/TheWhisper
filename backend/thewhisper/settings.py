import os
"""
Django settings for thewhisper project.
...
SECRET_KEY = 'django-insecure-h&3ybzp&9_=gm^ooo6gq(!@i+(4k@x5=n(9b$n9t+y*vve#l!b'
...
WSGI_APPLICATION = 'thewhisper.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Доп. папки со статикой
]
